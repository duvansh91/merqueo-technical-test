...
class Payment {
   ...
   * @param {Array<Object>} params.cash - List of bills or coins.
   */
  constructor(params) {
  ...
  */
  async create() {
    ...
    this.cash.forEach((value) => {
      totalIncomeCash += value.denomination * value.quantity
    })
    ...
    while (changeTemp > 0) {
      ...
      if (!billMatched) throw new Error('The cash register does not has change for this amount')
